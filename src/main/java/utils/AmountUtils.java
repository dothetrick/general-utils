...
public class AmountUtils {
    ...
    private static String[] unitArr = {"十", "百", "千", "万", "十", "百", "千", "亿", "十", "百", "千"};
    ...
    public static int countIdsNum(String ids) {
        ...
        return Objects.requireNonNull(StringUtils.split(ids, ",")).length;
    }
     ...
     * @return
     */
    public static int[] int2Arr(Integer integer) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(AmountUtils.toHanStr(874619875));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
